...
public class frmUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("SIMKES Khanza Cetak Antrian Loket Apotek");
        ...
        LabelTanggal.setText("Antrian Loket Apotek Tanggal :");
    ...
    private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
        if(Sequel.menyimpantf("antriloketapotekcetak","current_date(),current_time(),'"+LabelNomor.getText()+"'","Nomor Antrian")==true){
            ...
            Valid.MyReportqry("rptAntriLoketApotek.jasper","report","::[ Antrian Loket Apotek ]::",
                   "select date_format(antriloketapotekcetak.tanggal,'%d-%m-%Y') as tanggal,antriloketapotekcetak.nomor,antriloketapotekcetak.jam from antriloketapotekcetak where antriloketapotekcetak.tanggal=current_date and antriloketapotekcetak.nomor='"+LabelNomor.getText()+"' ",param);
    ...
    private void jam(){
        ActionListener taskPerformer = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                LabelTanggal.setText("Antrian Loket Apotek Tanggal : "+dtf.format(sekarang)); 
    ...
    private void autonomer(){
        Valid.autoNomer3("select ifnull(MAX(CONVERT(antriloketapotekcetak.nomor,signed)),0) from antriloketapotekcetak where antriloketapotekcetak.tanggal=current_date()","",3,LabelNomor);
    }
}
