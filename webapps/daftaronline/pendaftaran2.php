                    ...
                    <div class="card">
                        <div class="body">
                            <form id="form_validation" action="" method="POST">
                                ...
                                <label for="email_address">Tanggal Rencana Kunjungan <br>( Booking Pendaftaran Online dapat dilakukan pada Jadwal H+1 s/d H+7 dari saat melakukan pendaftaran online )</label>
                                <div class="form-group">
                                    <div class="form-line">
            							...
            							<select class="form-control show-tick" name="kd_poli" onchange="showDokter()">
                                            ...
                                            */?>
											...
											$result = query("
												...
												AND
													poliklinik.kd_poli NOT IN ('U0003')														
                                                AND
