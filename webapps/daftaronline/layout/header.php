...
$data=fetch_array(query("SELECT no_rkm_medis as username, tgl_lahir as password FROM pasien WHERE no_rkm_medis = '{$_COOKIE['username']}' AND tgl_lahir = '{$_COOKIE['password']}'"));
