        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">RS Syarif Hidayatullah</h4>
                </div>
				<div class="modal-body">
				Aplikasi Pendaftaran Online Rumah Sakit Syarif Hidayatullah
				</div>
			
                <div class="modal-body">

				<small>
        		  <p><b>Alamat:</b> Jl. Ir H. Juanda No.95, Pisangan, Kec. Ciputat Timur, Kota Tangerang Selatan, Banten 15419</p>
        		  <p><b>Email:</b> humas@rssyarifhidayatullah.com </p>
        		  <p><b>Instagram:</b> rssyahid </p>
        		  <p><b>Twitter:</b> @rssyahid </p>
        		  <p><b>Facebook:</b> rssyahid </p>
        		  <p><br><br></p>
        		  <p><b><u>Informasi: </u></b></p>
        		  <p><b>Hotline UGD:</b> 021-74701989</p>
        		  <p><b>Customer Service:</b> Hunting: (021) 744 0535 / 021-7402718 Ext. 100/200</p>
        		  <p><b>WhatsApp (WA) CS:</b> <a href="https://api.whatsapp.com/send?phone=628179125960" target="_blank"> 0817 9125 960 </a> </p>
				  <br>
				  <p><br></p>
        		  <p><b>WhatsApp (WA) Pendaftaran :</b> <a href="https://api.whatsapp.com/send?phone=6281808193232" target="_blank"> 0818 0819 3232 </a></p>
        		  <p><br><br></p>
				</small>
					<!--Ditetapkan sebagai Pendaftaran Online dengan Surat Keputusan Direktur Rumah Sakit Syarif Hidayatullah pada tanggal 01 Desember 2021.
					<ul style="list-style:none;margin-left:0;padding-left:0;"><br>
                        <li><b>Kepala Instalasi : <br>.........</b></li><br>
                        <li>Anggota :
