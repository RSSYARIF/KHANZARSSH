...
define('DB_PASS', 'ariaviv1234');
define('DB_NAME', 'sik10052021');

$connection = mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME);

define('VERSION', '1.8 Beta');
define('URL', 'http://daftaronline.rssyarifhidayatullah/');
define('DIR', '');
define('HARIDAFTAR', '07'); // Batasi hari pendaftaran 3 hari kedepan
define('LIMITJAM', '00:01:00'); // Batasi jam pendaftaran
...
//define('PANDUAN', 'ENABLE'); // ENABLE atau DISABLE fitur pengaduan pasien.
