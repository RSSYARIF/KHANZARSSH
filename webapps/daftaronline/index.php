                        ...
                        <div class="body table-responsive">
                            <table id="antrian" class="table table-bordered table-striped table-hover display nowrap dashboard-task-infos" width="100%">
                                <thead>
                                    <tr>-->
                                        <!--<th>Antrian</th>-->
										<!-- coddingan tabel dalam footer.php { mData: 'Antrian' },-->
                                        <!--<th>Status</th>-->
                                        <!--<th>Pasien</th>-->
                                        <!--<th>Dokter</th>-->
                                    <!--</tr>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2 align="center">ANTRIAN ANDA</h2>
							<h6 align="center"><font color="white">UPDATE DATA TERBARU PROFIL ANDA DENGAN MENGUNJUNGI UNIT PENDAFTARAN RUMAH SAKIT</font></h6>
                        </div>
