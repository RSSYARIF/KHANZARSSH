 ...
 * @author perpustakaan
 */
public class DlgHapusObatBillingParsial extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgHapusObatBillingParsial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabModePO=new DefaultTableModel(null,new Object[]{
                ...
                "Tuslah","Jml","Biaya Obat","Total","Harga Beli","Gudang","No.Batch","No.Faktur","Keterangan" //penambahan amelia yahya
            }){
            @Override 
            ...
            Class[] types = new Class[]{
                ...
                java.lang.Object.class,java.lang.Object.class,java.lang.Object.class //penambahan amelia yahya
            };
            @Override
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-08-2022" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Hapus Obat/Barang/Alkes/Perlengkapan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-08-2022" }));
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        ...
        //source code aslinya sudah diubah
        //source code aslinya sudah diubah
        if(tbPemberianObat.getSelectedRow()!= -1){
            bangsal=tbPemberianObat.getValueAt(tbPemberianObat.getSelectedRow(),13).toString();
        }if(tabModePO.getRowCount()==0){
        ...
        try{ 
            if(tbPemberianObat.getValueAt(tbPemberianObat.getSelectedRow(),16).toString().equals("Sudah di verifikasi")){ //penambahan oleh amelia yahya 26-07-2022      
                JOptionPane.showMessageDialog(rootPane,"Data billing Sudah di verifikasi, data tidak boleh dihapus..!!");
            }
            else if(tbPemberianObat.getValueAt(tbPemberianObat.getSelectedRow(),16).toString().equals("Sudah dibayar")){ //penambahan oleh amelia yahya 26-07-2022      
                JOptionPane.showMessageDialog(rootPane,"Data billing Sudah dibayar, data tidak boleh dihapus..!!");
            }
        } 
        catch(Exception x) {
            try{ 
                if(tbPemberianObat.getValueAt(tbPemberianObat.getSelectedRow(),17).toString().equals("Sudah dibayar")){ //penambahan oleh amelia yahya 26-07-2022      
                    JOptionPane.showMessageDialog(rootPane,"Data billing Sudah dibayar, data tidak boleh dihapus..!!");
                }
            }
            catch(Exception y) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgHapusObatBillingParsial dialog = new DlgHapusObatBillingParsial(new javax.swing.JFrame(), true);
    ...
    public void tampilPO() {
        ...
        sql="select detail_pemberian_obat.tgl_perawatan,detail_pemberian_obat.jam,"+
                   ...
                   "detail_pemberian_obat.kode_brng,databarang.nama_brng,detail_pemberian_obat.embalase,detail_pemberian_obat.tuslah,"+
                   "detail_pemberian_obat.jml,detail_pemberian_obat.biaya_obat,detail_pemberian_obat.total,detail_pemberian_obat.h_beli,"+
                   "detail_pemberian_obat.kd_bangsal,detail_pemberian_obat.no_batch,detail_pemberian_obat.no_faktur,verifikasi_obat.keterangan "+
                   "from detail_pemberian_obat inner join reg_periksa inner join pasien inner join databarang "+
                   "on detail_pemberian_obat.no_rawat=reg_periksa.no_rawat "+
                   "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                   "and detail_pemberian_obat.kode_brng=databarang.kode_brng "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabModePO.addRow(new Object[]{
                        ...
                        rs.getString(16),rs.getString(17) //penambahan amelia yahya
                    });
                }
            } catch (Exception e) {
