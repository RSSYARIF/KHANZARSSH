 ...
 * @author perpustakaan
 */
public class DlgPemberianObatKasir extends javax.swing.JDialog {
    ...
    private boolean sukses=true, ceksukses=false;
    
    /** Creates new form DlgPemberianObat
     * @param parent
     * @param modal */
    public DlgPemberianObatKasir(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        //di edit amelia yahya
        tabModePO=new DefaultTableModel(null,new Object[]{
                "P","Tgl.Beri","Jam Beri","No.Rawat","No.R.M.","Nama Pasien","Kode Obat","Nama Obat/Alkes","Embalase",
                "Tuslah","Jml","Biaya Obat","Total","Harga Beli","Gudang","No.Batch","No.Faktur","Keterangan","Status" //penambahan amelia yahya
            }){
        ...
        //source codeaslinya di edit amelia yahya
        /*for (int i = 0; i < 16; i++) {
        ...
        for (int i = 0; i < 18; i++) {
            ...
            if(i==0){
                ...
                column.setPreferredWidth(70);
            }else if(i==16){ //penambahan amelia yahya
                column.setPreferredWidth(100);
            }else if(i==17){ //penambahan amelia yahya
                column.setPreferredWidth(100);
            }
        }
    ...
    private void initComponents() {
        ...
        BtnBatalVerif = new widget.Button();
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2022" }));
        ...
        BtnVerif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/add-file-16x16.png"))); // NOI18N
        BtnVerif.setMnemonic('G');
        BtnVerif.setText("Verifikasi ");
        BtnVerif.setToolTipText("Alt+G");
        BtnVerif.setName("BtnVerif"); // NOI18N
        BtnVerif.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnVerif.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVerifActionPerformed(evt);
            }
        });
        BtnVerif.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnVerifKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnVerif);

        BtnBatalVerif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/delete_folder.png"))); // NOI18N
        BtnBatalVerif.setMnemonic('G');
        BtnBatalVerif.setText("Batal Verifikasi");
        BtnBatalVerif.setToolTipText("Alt+G");
        BtnBatalVerif.setName("BtnBatalVerif"); // NOI18N
        BtnBatalVerif.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnBatalVerif.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBatalVerifActionPerformed(evt);
            }
        });
        BtnBatalVerif.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnBatalVerifKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnBatalVerif);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2022" }));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2022" }));
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        ...
        if(tabModePO.getRowCount()==0){
             ...
             JOptionPane.showMessageDialog(null,"Maaf, Gagal menghapus. Pilih dulu data yang mau dihapus.\nKlik data pada table untuk memilih...!!!!");
                ...
                JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi, data tidak boleh dihapus.\nSilahkan hubungi bagian kasir/keuangan ..!!");
                TCari.requestFocus(); //ini buatan baru
        ...
        } //Kasir tidak pakai tombol hapus */
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void BtnVerifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerifActionPerformed
        ...
        for(int i=0;i<tabModePO.getRowCount();i++){
            if(tabModePO.getValueAt(i,0).toString().equals("true")){
                if(Sequel.menyimpantf("verifikasi_obat","?,?,?,?,?","Keterangan",5,new String[]{
                    tabModePO.getValueAt(i,3).toString(),
                    tabModePO.getValueAt(i,6).toString(),
                    tabModePO.getValueAt(i,1).toString(),tabModePO.getValueAt(i,2).toString(),"Sudah di verifikasi"
                })==true){
                    ceksukses=true;
                }else{
                    sukses=false;
    ...
    private void BtnVerifKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnVerifKeyPressed
        Valid.pindah(evt, BtnHapus, BtnKeluar);
    }//GEN-LAST:event_BtnVerifKeyPressed

    private void BtnBatalVerifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatalVerifActionPerformed
        //source code buatan Rania dan Amelia Yahya
        
        //int options=0;
        
        for(int i=0;i<tabModePO.getRowCount();i++){
            /*if(tabModePO.getValueAt(i,0).toString().equals("false")){ 
                options = 1;
            //JOptionPane.showMessageDialog(null,"Maaf, Silahkan pilihan Data Obat yang mau diverifikasi...!!!");
            }*/
            //else 
            /*if(tabModePO.getValueAt(i,17).toString().equals("Sudah dibayar")){ 
                options = 2;
            //JOptionPane.showMessageDialog(null,"Maaf, data tagihan obat pasien dengan No.Rawat tersebut sudah pernah dibayar...!!!...!!!");
            }*/
            //else 
            if(tabModePO.getValueAt(i,0).toString().equals("true")){
                if(Sequel.queryutf("delete from verifikasi_obat where no_rawat='"+tabModePO.getValueAt(i,3).toString()+
                    "' and kode_brng='"+tabModePO.getValueAt(i,6)+
                    "' and tgl_perawatan='"+tabModePO.getValueAt(i,1).toString()+
                    "' and jam='"+tabModePO.getValueAt(i,2).toString()+"'")==true){
                ceksukses=true;
            }else{
                sukses=false;
                }
        ...
        /*if(options == 1){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan pilihan Data yang mau diverifikasi...!!!");
        }
        else if(options == 2){
            JOptionPane.showMessageDialog(null,"Maaf, data tagihan obat pasien dengan No.Rawat tersebut sudah pernah dibayar...!!!");
        }*/
        ...
        tampilPO();
    }//GEN-LAST:event_BtnBatalVerifActionPerformed

    private void BtnBatalVerifKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnBatalVerifKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnBatalVerifKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPemberianObatKasir dialog = new DlgPemberianObatKasir(new javax.swing.JFrame(), true);
    ...
    private widget.Button BtnBatalVerif;
    ...
    public void tampilPO() {
        ...
        sql="select detail_pemberian_obat.tgl_perawatan,detail_pemberian_obat.jam,"+
                   ...
                   "detail_pemberian_obat.kode_brng,databarang.nama_brng,detail_pemberian_obat.embalase,detail_pemberian_obat.tuslah,"+
                   "detail_pemberian_obat.jml,detail_pemberian_obat.biaya_obat,detail_pemberian_obat.total,detail_pemberian_obat.h_beli,"+
                   "detail_pemberian_obat.kd_bangsal,detail_pemberian_obat.no_batch,detail_pemberian_obat.no_faktur,verifikasi_obat.keterangan,(case billing.`status` WHEN 'Obat' THEN 'Sudah dibayar' END) as status "+
                   "from detail_pemberian_obat inner join reg_periksa inner join pasien inner join databarang "+
                   "on detail_pemberian_obat.no_rawat=reg_periksa.no_rawat "+
                   "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                   "and detail_pemberian_obat.kode_brng=databarang.kode_brng "+
                   "left join verifikasi_obat on detail_pemberian_obat.no_rawat=verifikasi_obat.no_rawat "+
                   "and detail_pemberian_obat.kode_brng=verifikasi_obat.kode_brng "+
                   "and detail_pemberian_obat.tgl_perawatan=verifikasi_obat.tgl_perawatan and detail_pemberian_obat.jam=verifikasi_obat.jam "+
                   "left join billing on detail_pemberian_obat.no_rawat=.billing.no_rawat "+
                   "and detail_pemberian_obat.biaya_obat=billing.biaya "+
                   "and detail_pemberian_obat.jml=billing.jumlah "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabModePO.addRow(new Object[]{
                        ...
                        rs.getString(16)*/
                        //diedit oleh amelia yahya
                        false,rs.getString(1),rs.getString(2),rs.getString(3),
                        rs.getString(4),rs.getString(5),rs.getString(6),
                        rs.getString(7),rs.getDouble(8),rs.getDouble(9),
                        rs.getDouble(10),rs.getDouble(11),rs.getDouble(12),
                        rs.getDouble(13),rs.getString(14),rs.getString(15),
                        rs.getString(16),rs.getString(17),rs.getString(18) //penambahan amelia yahya
                    });
                }
            } catch (Exception e) {
