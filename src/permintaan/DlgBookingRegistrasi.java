...
public class DlgBookingRegistrasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnDokterBerhalangan = new javax.swing.JMenuItem();
        MnBelum = new javax.swing.JMenuItem();
        MnSudahRegist = new javax.swing.JMenuItem();
        ...
        MnDokterBerhalangan.setBackground(new java.awt.Color(255, 255, 254));
        MnDokterBerhalangan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnDokterBerhalangan.setForeground(new java.awt.Color(50, 50, 50));
        MnDokterBerhalangan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnDokterBerhalangan.setText("Dokter Berhalangan");
        MnDokterBerhalangan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnDokterBerhalangan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnDokterBerhalangan.setName("MnDokterBerhalangan"); // NOI18N
        MnDokterBerhalangan.setPreferredSize(new java.awt.Dimension(180, 26));
        MnDokterBerhalangan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnDokterBerhalanganActionPerformed(evt);
            }
        });
        MnStatus.add(MnDokterBerhalangan);
        ...
        MnSudahRegist.setBackground(new java.awt.Color(255, 255, 254));
        MnSudahRegist.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSudahRegist.setForeground(new java.awt.Color(50, 50, 50));
        MnSudahRegist.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSudahRegist.setText("Sudah Registrasi");
        MnSudahRegist.setToolTipText("");
        MnSudahRegist.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnSudahRegist.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnSudahRegist.setName("MnSudahRegist"); // NOI18N
        MnSudahRegist.setPreferredSize(new java.awt.Dimension(180, 26));
        MnSudahRegist.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSudahRegistActionPerformed(evt);
            }
        });
        MnStatus.add(MnSudahRegist);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-09-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-09-2022" }));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-09-2022" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-09-2022" }));
        ...
        TanggalBooking.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-09-2022 11:22:44" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-09-2022 11:22:44" }));
  ...
  isForm();                
    ...
    private void ppCSVWARocketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCSVWARocketActionPerformed
        try {
            ...
            //source code perbaikan amelia yahya
            for(i=0;i<tabMode.getRowCount();i++){  
                try {
                    nohp="";
                    if(tabMode.getValueAt(i,26).toString().substring(0,1).equals("0")){
                    ...
                    htmlContent.append(
                        "\" "+nohp+"\";\""+"Assalamu'alaikum wr wb, \n \nMengingatkan kembali kepada *"+tabMode.getValueAt(i,4)+"* No.RM *"+tabMode.getValueAt(i,3)+"*, berdasarkan booking pendaftaran online pada tanggal "+tabMode.getValueAt(i,1)+" tujuan *"+tabMode.getValueAt(i,9)+"* dengan nomor antrian "+tabMode.getValueAt(i,10)+", diharapkan datang ke Rumah Sakit Syarif Hidayatullah pada tanggal "+tabMode.getValueAt(i,5)+". \n \nTerimakasih. \nWassalamu'alaikum. \nCustomer Service "+akses.getnamars()+"\"\n"
                    );
                } catch (Exception e) {
                }
            }
    ...
    private void BtnEdit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEdit1ActionPerformed
     // Source code dibuat oleh amelia yahya dan Rania
            Sequel.queryu2("update booking_registrasi set no_rkm_medis=?,kd_dokter=?,kd_poli=?,no_reg=?,kd_pj=? where no_rkm_medis=? and status='Belum' and tanggal_booking=? ",7,
                            new String[]{
                                TNoRM.getText(),KdDokter.getText(),KdPoli.getText(),NoReg.getText(),kdpnj.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),3).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()
                            }
                        );
                        tampil();
                        emptTeks();
                        //JOptionPane.showMessageDialog(rootPane,"Maaf data sudah di Registrasi tidak bisa di ubah/ganti..!!! ");
                        //TCari.requestFocus(); 

           /* if(Sequel.mengedittf("booking_registrasi","no_rkm_medis=? and status='Belum'","no_rkm_medis=?,kd_dokter=?,kd_poli=?,no_reg=?,kd_pj=?",6,new String[]{
                        TNoRM.getText(),KdDokter.getText(),KdPoli.getText(),NoReg.getText(),kdpnj.getText(),kdpnj.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),3).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),10).toString()
                    })==true){
                            /*Sequel.queryu2("update booking_registrasi set no_rkm_medis=?,kd_dokter=?,kd_poli=?,no_reg=?,kd_pj=? where no_rkm_medis=?",6,
                            new String[]{
                            TNoRM.getText(),KdDokter.getText(),KdPoli.getText(),NoReg.getText(),kdpnj.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),3).toString()
                            }           
                            );
                    JOptionPane.showMessageDialog(rootPane,"Data sudah berhasil di ubah/ganti..!!! ");
                    emptTeks();
                    tampil(); 
                }else{
                JOptionPane.showMessageDialog(rootPane,"Maaf data sudah di Registrasi tidak bisa di ubah/ganti..!!! ");
           ...
           /*if(Sequel.queryu2tf("update booking_registrasi set no_rkm_medis=?,kd_dokter=?,kd_poli=?,no_reg=?,kd_pj=? where no_rkm_medis=? and status='Belum'",6,
                            new String[]{
                                TNoRM.getText(),KdDokter.getText(),KdPoli.getText(),NoReg.getText(),kdpnj.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),3).toString()
                            })==true){
                    JOptionPane.showMessageDialog(rootPane,"Data sudah berhasil di ubah/ganti..!!! ");
    ...
    private void MnBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBatalActionPerformed
        //penambahan amelia yahya
        /*if(TNoRM.getText().trim().equals("")){
            Valid.textKosong(TNoRM,"No.RM");
        }else{
                Valid.editTable(tabMode,"booking_registrasi","no_rkm_medis",TNoRM,"status='Batal'");
        ...
        if(TNoRM.getText().trim().equals("")){
            Valid.textKosong(TNoRM,"No.RM");
                ...
                Sequel.queryu2("update booking_registrasi set no_rkm_medis=?,kd_dokter=?,kd_poli=?,no_reg=?,kd_pj=?,status=? where no_rkm_medis=? and tanggal_booking=?",8,
                            new String[]{
                                TNoRM.getText(),KdDokter.getText(),KdPoli.getText(),NoReg.getText(),kdpnj.getText(),"Batal",tbObat.getValueAt(tbObat.getSelectedRow(),3).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()
                            }
                        );
                        tampil();
                        emptTeks();
    ...
    private void MnDokterBerhalanganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDokterBerhalanganActionPerformed
        //penambahan amelia yahya
        /*if(TNoRM.getText().trim().equals("")){
            Valid.textKosong(TNoRM,"No.RM");
        }else{
                Valid.editTable(tabMode,"booking_registrasi","no_rkm_medis",TNoRM,"status='Dokter Berhalangan'");
                if(tabMode.getRowCount()!=0){tampil();}
        }
        gagal
        */
        if(TNoRM.getText().trim().equals("")){
            Valid.textKosong(TNoRM,"No.RM");
                ...
                Sequel.queryu2("update booking_registrasi set no_rkm_medis=?,kd_dokter=?,kd_poli=?,no_reg=?,kd_pj=?,status=? where no_rkm_medis=? and tanggal_booking=?",8,
                            new String[]{
                                TNoRM.getText(),KdDokter.getText(),KdPoli.getText(),NoReg.getText(),kdpnj.getText(),"Dokter Berhalangan",tbObat.getValueAt(tbObat.getSelectedRow(),3).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()
                            }
                        );
                        tampil();
                        emptTeks();
        }
    }//GEN-LAST:event_MnDokterBerhalanganActionPerformed
    ...
    private void MnBelumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBelumActionPerformed
        ...
        /*if(TNoRM.getText().trim().equals("")){
            Valid.textKosong(TNoRM,"No.RM");
                ...
                Valid.editTable(tabMode,"booking_registrasi","no_rkm_medis",TNoRM,"status='Belum'");
                if(tabMode.getRowCount()!=0){tampil();}
        }
        gagal
        */
        if(TNoRM.getText().trim().equals("")){
            Valid.textKosong(TNoRM,"No.RM");
                ...
                Sequel.queryu2("update booking_registrasi set no_rkm_medis=?,kd_dokter=?,kd_poli=?,no_reg=?,kd_pj=?,status=? where no_rkm_medis=? and tanggal_booking=?",8,
                            new String[]{
                                TNoRM.getText(),KdDokter.getText(),KdPoli.getText(),NoReg.getText(),kdpnj.getText(),"Belum",tbObat.getValueAt(tbObat.getSelectedRow(),3).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()
                            }
                        );
                        tampil();
                        emptTeks();
    ...
    private void MnSudahRegistActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSudahRegistActionPerformed
        //penambahan amelia yahya
        /*if(TNoRM.getText().trim().equals("")){
            Valid.textKosong(TNoRM,"No.RM");
        }else{
                Valid.editTable(tabMode,"booking_registrasi","no_rkm_medis",TNoRM,"status='Terdaftar'");
                if(tabMode.getRowCount()!=0){tampil();}
        }
        gagal
        */
        if(TNoRM.getText().trim().equals("")){
            Valid.textKosong(TNoRM,"No.RM");
                ...
                Sequel.queryu2("update booking_registrasi set no_rkm_medis=?,kd_dokter=?,kd_poli=?,no_reg=?,kd_pj=?,status=? where no_rkm_medis=? and tanggal_booking=?",8,
                            new String[]{
                                TNoRM.getText(),KdDokter.getText(),KdPoli.getText(),NoReg.getText(),kdpnj.getText(),"Terdaftar",tbObat.getValueAt(tbObat.getSelectedRow(),3).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()
                            }
                        );
                        tampil();
                        emptTeks();
        }
    }//GEN-LAST:event_MnSudahRegistActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnDokterBerhalangan;
    private javax.swing.JMenu MnStatus;
    private javax.swing.JMenuItem MnSudahRegist;
