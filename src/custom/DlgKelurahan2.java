...
public class DlgKelurahan2 extends javax.swing.JDialog {
    ...
    /** Creates new form Dlgkelurahan2
     * @param parent
     * @param modal */
    public DlgKelurahan2(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Kelurahan","Kelurahan","Kecamatan","Kabupaten","Propinsi","kd kec","kd kab"," kd prop"};
        ...
        try {
            ps=koneksi.prepareStatement("select kelurahan2.kd_kel,kelurahan2.nm_kel,kecamatan2.nm_kec,kabupaten2.nm_kab,propinsi2.nm_prop,kecamatan2.kd_kec,kabupaten2.kd_kab,propinsi2.kd_prop from kelurahan2 inner join kecamatan2 inner join kabupaten2 inner join propinsi2 on "+
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Kelurahan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        CMbTCari.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kecamatan","Kelurahan" }));
    ...
    */
    ...
    private void tampilCari() {
        ...
        if(CMbTCari.getSelectedItem()=="Kelurahan"){           
            try{ 
                ps3=koneksi.prepareStatement("select kelurahan2.kd_kel,kelurahan2.nm_kel,kecamatan2.nm_kec,kabupaten2.nm_kab,propinsi2.nm_prop,kecamatan2.kd_kec,kabupaten2.kd_kab,propinsi2.kd_prop from kelurahan2 inner join kecamatan2 inner join kabupaten2 inner join propinsi2 on "+
                                        "kelurahan2.kd_kec=kecamatan2.kd_kec and kelurahan2.kd_kab=kabupaten2.kd_kab and kelurahan2.kd_prop=propinsi2.kd_prop where kelurahan2.nm_kel like ? order by kelurahan2.nm_kel desc limit ?  ");
            ...
            try{      
                ps2=koneksi.prepareStatement("select kelurahan2.kd_kel,kelurahan2.nm_kel,kecamatan2.nm_kec,kabupaten2.nm_kab,propinsi2.nm_prop,kecamatan2.kd_kec,kabupaten2.kd_kab,propinsi2.kd_prop from kelurahan2 inner join kecamatan2 inner join kabupaten2 inner join propinsi2 on "+
