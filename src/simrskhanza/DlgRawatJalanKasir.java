 ...
 * @author dosen
 */
public final class DlgRawatJalanKasir extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRawatJalanKasir(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabModeDr=new DefaultTableModel(null,new Object[]{
            "P","No.Rawat","No.R.M.","Nama Pasien","Perawatan/Tindakan","Kode Dokter","Dokter Yg Menangani","Tgl.Rawat","Jam Rawat","Biaya","Kode","Tarif Dokter","KSO","Jasa Sarana","BHP","Menejemen","Keterangan"}){   //penambahan amelia yahya
             ...
             Class[] types = new Class[] {
                 ...
                 java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, 
                 java.lang.Object.class, java.lang.String.class //penambahan amelia yahya
             };
             @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rincian Perawatan/Tindakan Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2022" }));
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnEdit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEdit1ActionPerformed
        ...
        for(i=0;i<tbRawatDr.getRowCount();i++){
            if(tbRawatDr.getValueAt(i,0).toString().equals("true")){
                if(Sequel.menyimpantf("verifikasi_ralan_dr","?,?,?,?,?","Keterangan",5,new String[]{
                    tbRawatDr.getValueAt(i,1).toString(),
                    tbRawatDr.getValueAt(i,10).toString(),
                    tbRawatDr.getValueAt(i,7).toString(),tbRawatDr.getValueAt(i,8).toString(),"Sudah di verifikasi"
                })==true){
                    ceksukses=true;
                }else{
                    sukses=false;
    ...
    private void BtnBatalVerifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatalVerifActionPerformed
        ...
        for(i=0;i<tbRawatDr.getRowCount();i++){
            /*if(tbRawatDr.getValueAt(i,0).toString().equals("false")){ 
                options = 1;
            }*/
            //else 
            /*if(tbRawatDr.getValueAt(i,16).toString().equals("Sudah dibayar")){ 
                options = 2;
            }
            else */
            if(tbRawatDr.getValueAt(i,0).toString().equals("true")){
                if(Sequel.queryutf("delete from verifikasi_ralan_dr where no_rawat='"+tbRawatDr.getValueAt(i,1).toString()+
                    "' and kd_jenis_prw='"+tbRawatDr.getValueAt(i,10)+
                    "' and tgl_perawatan='"+tbRawatDr.getValueAt(i,7).toString()+
                    "' and jam_rawat='"+tbRawatDr.getValueAt(i,8).toString()+"'")==true){
                ceksukses=true;
        ...
        /*if(options == 1){
            ...
            JOptionPane.showMessageDialog(null,"Maaf, data tindakan pasien dengan No.Rawat tersebut sudah pernah dibayar...!!!");
        }*/
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRawatJalanKasir dialog = new DlgRawatJalanKasir(new javax.swing.JFrame(), true);
    ...
    private void tampilDr() {
        ...
        try{
            ...
            //source code di edit amelia yahya
            ps=koneksi.prepareStatement("select rawat_jl_dr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                   "concat(rawat_jl_dr.kd_jenis_prw,' ',jns_perawatan.nm_perawatan),rawat_jl_dr.kd_dokter,dokter.nm_dokter,"+
                   "rawat_jl_dr.tgl_perawatan,rawat_jl_dr.jam_rawat,rawat_jl_dr.biaya_rawat,rawat_jl_dr.kd_jenis_prw, " +
                   "rawat_jl_dr.tarif_tindakandr,rawat_jl_dr.kso,rawat_jl_dr.material,rawat_jl_dr.bhp,rawat_jl_dr.menejemen,verifikasi_ralan_dr.keterangan "+
                   "from pasien inner join reg_periksa inner join jns_perawatan inner join "+
                   "dokter inner join rawat_jl_dr "+
                   "on rawat_jl_dr.no_rawat=reg_periksa.no_rawat "+
                   "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                   "and rawat_jl_dr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "+
                   "and rawat_jl_dr.kd_dokter=dokter.kd_dokter "+
                   "left join verifikasi_ralan_dr on rawat_jl_dr.no_rawat=verifikasi_ralan_dr.no_rawat "+
                   "and rawat_jl_dr.kd_jenis_prw=verifikasi_ralan_dr.kd_jenis_prw "+
                   "and rawat_jl_dr.tgl_perawatan=verifikasi_ralan_dr.tgl_perawatan and rawat_jl_dr.jam_rawat=verifikasi_ralan_dr.jam_rawat "+
                   "where rawat_jl_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and rawat_jl_dr.no_rawat like ? or "+
                    "rawat_jl_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and reg_periksa.no_rkm_medis like ? or "+
                    "rawat_jl_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and pasien.nm_pasien like ? or "+
                    "rawat_jl_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and jns_perawatan.nm_perawatan like ? or "+
                    "rawat_jl_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and rawat_jl_dr.kd_dokter like ? or "+
                    "rawat_jl_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and dokter.nm_dokter like ? or "+
                    "rawat_jl_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and rawat_jl_dr.tgl_perawatan like ? "+
            ...
            try {
                ...
                while(rs.next()){
                    tabModeDr.addRow(new Object[]{
                        ...
                        rs.getString("material"),rs.getString("bhp"),rs.getString("menejemen"),rs.getString("keterangan") //penambahan amelia yahya
                    });
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e);
