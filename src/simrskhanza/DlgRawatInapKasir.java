 ...
 * @author perpustakaan
 */
public final class DlgRawatInapKasir extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRawatInapKasir(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rincian Perawatan/Tindakan Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnEdit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEdit1ActionPerformed
        ...
        for(i=0;i<tbRawatDr.getRowCount();i++){
            if(tbRawatDr.getValueAt(i,0).toString().equals("true")){
                if(Sequel.menyimpantf("verifikasi_ranap_dr","?,?,?,?,?","Keterangan",5,new String[]{
    ...
    private void BtnBatalVerifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatalVerifActionPerformed
        for(i=0;i<tbRawatDr.getRowCount();i++){
            if(tbRawatDr.getValueAt(i,0).toString().equals("true")){
                if(Sequel.queryutf("delete from verifikasi_ranap_dr where no_rawat='"+tbRawatDr.getValueAt(i,1).toString()+
                    "' and kd_jenis_prw='"+tbRawatDr.getValueAt(i,10)+
                    "' and tgl_perawatan='"+tbRawatDr.getValueAt(i,7).toString()+
                    "' and jam_rawat='"+tbRawatDr.getValueAt(i,8).toString()+"'")==true){
                ceksukses=true;
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRawatInapKasir dialog = new DlgRawatInapKasir(new javax.swing.JFrame(), true);
    ...
    public void tampilDr() {
        ...
        /*try{
            ...
            //source code di edit oleh Amelia Yahya
            try{
            if(TCari.getText().equals("")&&TCariPasien.getText().equals("")){
                ps=koneksi.prepareStatement("select rawat_inap_dr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                   "concat(rawat_inap_dr.kd_jenis_prw,' ',jns_perawatan_inap.nm_perawatan),rawat_inap_dr.kd_dokter,dokter.nm_dokter,"+
                   "rawat_inap_dr.tgl_perawatan,rawat_inap_dr.jam_rawat,rawat_inap_dr.biaya_rawat,rawat_inap_dr.kd_jenis_prw, " +
                   "rawat_inap_dr.tarif_tindakandr,rawat_inap_dr.kso,rawat_inap_dr.material,rawat_inap_dr.bhp,rawat_inap_dr.menejemen,verifikasi_ranap_dr.keterangan "+
                   "from pasien inner join reg_periksa inner join jns_perawatan_inap inner join "+
                   "dokter inner join rawat_inap_dr "+
                   "on rawat_inap_dr.no_rawat=reg_periksa.no_rawat "+
                   "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                   "and rawat_inap_dr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
                   "and rawat_inap_dr.kd_dokter=dokter.kd_dokter "+
                   "left join verifikasi_ranap_dr on rawat_inap_dr.no_rawat=verifikasi_ranap_dr.no_rawat "+
                   "and rawat_inap_dr.kd_jenis_prw=verifikasi_ranap_dr.kd_jenis_prw "+
                   "and rawat_inap_dr.tgl_perawatan=verifikasi_ranap_dr.tgl_perawatan and rawat_inap_dr.jam_rawat=verifikasi_ranap_dr.jam_rawat "+
                ...
                ps=koneksi.prepareStatement("select rawat_inap_dr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                   ...
                   "where rawat_inap_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and rawat_inap_dr.no_rawat like ? or "+
                    ...
                    "rawat_inap_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and rawat_inap_dr.kd_dokter like ? or "+
                    "rawat_inap_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and dokter.nm_dokter like ? or "+
                    "rawat_inap_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and rawat_inap_dr.tgl_perawatan like ? "+
